...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelKit.box_image'
        db.add_column('kitreviews_modelkit', 'box_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelKit.box_image'
        db.delete_column('kitreviews_modelkit', 'box_image')
