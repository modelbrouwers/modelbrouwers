...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelKit.difficulty'
        db.add_column('kitreviews_modelkit', 'difficulty',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3),
                      keep_default=False)

        # Deleting field 'KitReview.difficulty'
        db.delete_column('kitreviews_kitreview', 'difficulty')


    def backwards(self, orm):
        # Deleting field 'ModelKit.difficulty'
        db.delete_column('kitreviews_modelkit', 'difficulty')

        # Adding field 'KitReview.difficulty'
        db.add_column('kitreviews_kitreview', 'difficulty',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3),
                      keep_default=False)
    ...
    models = {
        'albums.album': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'album 06-06-2013'", 'max_length': "'256'", 'db_index': 'True'}),
        ...
        'kitreviews.modelkit': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['kitreviews.Category']", 'null': 'True'}),
