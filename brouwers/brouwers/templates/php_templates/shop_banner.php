...
<li>
    <a href="/shop/catalog/xuron-m-52.html?language=nl&amp;amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/xuron.gif" alt="Xuron" width="102" /></a>
</li>
<li>
    <a href="/shop/catalog/revell-m-14.html?language=nl&amp;amp;sort=3d">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/revell.gif" alt="Revell" width="62" /></a>
</li>
<li>
    <a href="/shop/catalog/alclad2-m-19.html?language=nl&amp;amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/alclad.gif" alt="Alclad" width="65" /></a>
</li>
<li>
    <a href="/shop/catalog/bare-metal-foil-m-15.html?language=nl&amp;amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/bmf.gif" alt="Bare Metal Foil" width="66" /></a>
</li>
<li>
    <a href="/shop/catalog/birchwood-casey-m-44.html?language=nl&amp;amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/birchwood_casey.gif" alt="Birchwood Casey" width="52" /></a>
</li>
<li>
    <a href="/shop/catalog/createx-m-23.html?language=nl&amp;amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/createx.gif" alt="Createx" width="54" /></a>
</li>
<li>
    <a href="/shop/catalog/evergreen-m-11.html?language=nl&amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/evergreen.gif" alt="Evergreen" width="50" /></a>
</li>
<li>
    <a href="/shop/catalog/billing-boats-m-29.html?language=nl&amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/billing.gif" alt="Billing Boats" width="41" /></a>
</li>
<li>
    <a href="/shop/catalog/excel-m-35.html?language=nl&amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/excel.gif" alt="Excel" width="56" /></a>
</li>
<li>
    <a href="/shop/catalog/rc-afstandbestuurbaar-rcsets-billing-boats-c-106_120.html?language=nl&amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/graupner.gif" alt="Graupner" width="65" /></a>
</li>
<li>
    <a href="/shop/catalog/mamoli-m-32.html?language=nl&amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/mamoli.gif" alt="Mamoli" width="82" /></a>
</li>
<li>
    <a href="/shop/catalog/microscale-m-17.html?language=nl&amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/microscale.gif" alt="Microscale" width="62" /></a>
</li>
<li>
    <a href="/shop/catalog/milliput-m-26.html?language=nl&amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/milliput.gif" alt="Milliput" width="93" /></a>
</li>
<li>
    <a href="/shop/catalog/modelbrouwers-m-12.html?language=nl&amp;page=1&amp;sort=3d">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/modelbrouwers.gif" alt="Modelbrouwers" width="127" /></a>
</li>
<li>
    <a href="/shop/catalog/rustall-m-53.html?language=nl&amp;sort=2a">
        <img src="<?php echo $settings['STATIC_URL']; ?>images/shop/rustall.gif" alt="Rustall" width="93" /></a>
</li>
<li>
    <a href="/shop/catalog/scalemotorsport-m-24.html?language=nl&amp;sort=2a">
