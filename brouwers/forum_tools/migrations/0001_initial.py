...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('forum_tools_forumlinkbase', (
        ...
        db.send_create_signal('forum_tools', ['ForumLinkBase'])

        # Adding model 'ForumLinkSynced'
        db.create_table('forum_tools_forumlinksynced', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('base', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum_tools.ForumLinkBase'])),
            ('link_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('forum_tools', ['ForumLinkSynced'])

        # Adding model 'ForumPostCountRestriction'
        db.create_table('forum_tools_forumpostcountrestriction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('forum', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum_tools.Forum'])),
        ...
        db.send_create_signal('forum_tools', ['ForumPostCountRestriction'])


    def backwards(self, orm):
        # Deleting model 'ForumLinkBase'
        db.delete_table('forum_tools_forumlinkbase')

        # Deleting model 'ForumLinkSynced'
        db.delete_table('forum_tools_forumlinksynced')

        # Deleting model 'ForumPostCountRestriction'
        db.delete_table('forum_tools_forumpostcountrestriction')
