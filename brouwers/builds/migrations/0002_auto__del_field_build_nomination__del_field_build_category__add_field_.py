...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Build.nomination'
        db.delete_column('builds_build', 'nomination_id')

        # Deleting field 'Build.category'
        db.delete_column('builds_build', 'category_id')

        # Adding field 'Build.user'
        db.add_column('builds_build', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Build.topic_id'
        db.add_column('builds_build', 'topic_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Build.forum_id'
        db.add_column('builds_build', 'forum_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Build.brand_name'
        db.add_column('builds_build', 'brand_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Build.nomination'
        db.add_column('builds_build', 'nomination',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.Project'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Build.category'
        db.add_column('builds_build', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.Category'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Build.user'
        db.delete_column('builds_build', 'user_id')

        # Deleting field 'Build.topic_id'
        db.delete_column('builds_build', 'topic_id')

        # Deleting field 'Build.forum_id'
        db.delete_column('builds_build', 'forum_id')

        # Deleting field 'Build.brand_name'
        db.delete_column('builds_build', 'brand_name')
