...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('builds_build', 'scale', 'scale_char')
        db.rename_column('builds_build', 'scale_int', 'scale')

    def backwards(self, orm):
        db.rename_column('builds_build', 'scale', 'scale_int')
        db.rename_column('builds_build', 'scale_char', 'scale')
    ...
    models = {
        ...
        'builds.build': {
            ...
            'scale_char': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
