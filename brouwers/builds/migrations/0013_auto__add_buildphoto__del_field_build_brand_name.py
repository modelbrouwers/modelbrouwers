...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('builds_buildphoto', (
        ...
        db.send_create_signal('builds', ['BuildPhoto'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('builds_buildphoto')
    ...
    models = {
        'albums.album': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'album 17-10-2013'", 'max_length': "'256'", 'db_index': 'True'}),
        ...
        'builds.buildphoto': {
            'Meta': {'ordering': "['order']", 'object_name': 'BuildPhoto'},
