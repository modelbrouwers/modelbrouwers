...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelKit.category'
        db.add_column('kitreviews_modelkit', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kitreviews.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelKit.category'
        db.delete_column('kitreviews_modelkit', 'category_id')
    ...
    models = {
        ...
        'kitreviews.modelkit': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['kitreviews.Category']", 'null': 'True', 'blank': 'True'}),
