...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('kitreviews_brand', 'logo',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('kitreviews_brand', 'logo')
    ...
    models = {
        'albums.album': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'album 16-10-2013'", 'max_length': "'256'", 'db_index': 'True'}),
