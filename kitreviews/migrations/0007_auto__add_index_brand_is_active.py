...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Brand', fields ['is_active']
        db.create_index('kitreviews_brand', ['is_active'])


    def backwards(self, orm):
        # Removing index on 'Brand', fields ['is_active']
        db.delete_index('kitreviews_brand', ['is_active'])
    ...
    models = {
        'albums.album': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'album 06-10-2013'", 'max_length': "'256'", 'db_index': 'True'}),
