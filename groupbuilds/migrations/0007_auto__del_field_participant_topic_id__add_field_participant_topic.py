...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'groupbuilds.groupbuild': {
            ...
            'homepage_topic': ('forum_tools.fields.ForumToolsIDField', [], {'null': 'True', 'type': "'topic'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'introduction_topic': ('forum_tools.fields.ForumToolsIDField', [], {'null': 'True', 'type': "'topic'", 'blank': 'True'}),
            ...
            'rules_topic': ('forum_tools.fields.ForumToolsIDField', [], {'null': 'True', 'type': "'topic'", 'blank': 'True'}),
        ...
        u'groupbuilds.participant': {
            ...
            'topic': ('forum_tools.fields.ForumToolsIDField', [], {'null': 'True', 'type': "'topic'", 'blank': 'True'}),
