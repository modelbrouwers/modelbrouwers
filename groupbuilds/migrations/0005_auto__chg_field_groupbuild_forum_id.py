...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupBuild.homepage_topic_id'
        db.alter_column(u'groupbuilds_groupbuild', 'homepage_topic_id', self.gf('forum_tools.fields.ForumToolsIDField')(null=True, type='topic'))

        # Changing field 'GroupBuild.forum_id'
        db.alter_column(u'groupbuilds_groupbuild', 'forum_id', self.gf('forum_tools.fields.ForumToolsIDField')(null=True, type='forum'))

        # Changing field 'GroupBuild.rules_topic_id'
        db.alter_column(u'groupbuilds_groupbuild', 'rules_topic_id', self.gf('forum_tools.fields.ForumToolsIDField')(null=True, type='topic'))

        # Changing field 'GroupBuild.introduction_topic_id'
        db.alter_column(u'groupbuilds_groupbuild', 'introduction_topic_id', self.gf('forum_tools.fields.ForumToolsIDField')(null=True, type='topic'))

    def backwards(self, orm):

        # Changing field 'GroupBuild.homepage_topic_id'
        db.alter_column(u'groupbuilds_groupbuild', 'homepage_topic_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'GroupBuild.forum_id'
        db.alter_column(u'groupbuilds_groupbuild', 'forum_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'GroupBuild.rules_topic_id'
        db.alter_column(u'groupbuilds_groupbuild', 'rules_topic_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'GroupBuild.introduction_topic_id'
        db.alter_column(u'groupbuilds_groupbuild', 'introduction_topic_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        u'groupbuilds.groupbuild': {
            ...
            'forum_id': ('forum_tools.fields.ForumToolsIDField', [], {'null': 'True', 'type': "'forum'", 'blank': 'True'}),
            'homepage_topic_id': ('forum_tools.fields.ForumToolsIDField', [], {'null': 'True', 'type': "'topic'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'introduction_topic_id': ('forum_tools.fields.ForumToolsIDField', [], {'null': 'True', 'type': "'topic'", 'blank': 'True'}),
            ...
            'rules_topic_id': ('forum_tools.fields.ForumToolsIDField', [], {'null': 'True', 'type': "'topic'", 'blank': 'True'}),
