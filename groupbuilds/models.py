...
class GroupBuild(ForumMixin, models.Model):
    forum_id = models.PositiveIntegerField(_('forum id'), blank=True, null=True,
    ...
    category = models.ForeignKey(ForumCategory, verbose_name=_('forum category'))
    ...
    rules_topic_id = models.PositiveIntegerField(_('rules topic'), blank=True, null=True)
    homepage_topic_id = models.PositiveIntegerField(_('topic to direct to from calendar'), blank=True, null=True)
...
class Participant(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='gb_participants')
