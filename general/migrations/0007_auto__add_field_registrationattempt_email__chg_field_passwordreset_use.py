...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistrationAttempt.email'
        db.add_column(u'general_registrationattempt', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'PasswordReset.user'
        db.alter_column(u'general_passwordreset', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

        # Changing field 'UserProfile.user'
        db.alter_column(u'general_userprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'], unique=True))

    def backwards(self, orm):
        # Deleting field 'RegistrationAttempt.email'
        db.delete_column(u'general_registrationattempt', 'email')


        # Changing field 'PasswordReset.user'
        db.alter_column(u'general_passwordreset', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'UserProfile.user'
        db.alter_column(u'general_userprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))
