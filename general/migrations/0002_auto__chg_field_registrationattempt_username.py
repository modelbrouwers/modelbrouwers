...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegistrationAttempt.username'
        db.alter_column('general_registrationattempt', 'username', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'RegistrationAttempt.username'
        db.alter_column('general_registrationattempt', 'username', self.gf('django.db.models.fields.CharField')(max_length=30))
