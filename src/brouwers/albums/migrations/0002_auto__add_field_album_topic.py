...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.topic'
        db.add_column(u'albums_album', 'topic',
                      self.gf('brouwers.forum_tools.fields.ForumToolsIDField')(null=True, type='topic', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.topic'
        db.delete_column(u'albums_album', 'topic_id')
    ...
    models = {
        u'albums.album': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'album 12-03-2015'", 'max_length': "'256'", 'db_index': 'True'}),
