...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'albums_album', (
            ...
            ('title', self.gf('django.db.models.fields.CharField')(default='album 14-04-2014', max_length='256', db_index=True)),
    ...
    models = {
        u'albums.album': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'album 14-04-2014'", 'max_length': "'256'", 'db_index': 'True'}),
