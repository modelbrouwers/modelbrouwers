...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'builds_build', (
            ...
            ('topic_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True, blank=True)),
            ('forum_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('scale', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ...
        # Adding model 'BuildPhoto'
        db.create_table(u'builds_buildphoto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('build', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['builds.Build'])),
            ('photo', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['albums.Photo'], unique=True, null=True, blank=True)),
        ...
        db.send_create_signal(u'builds', ['BuildPhoto'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'BuildPhoto'
        db.delete_table(u'builds_buildphoto')
    ...
    models = {
        ...
        u'builds.build': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['general.UserProfile']"}),
        ...
        u'builds.buildphoto': {
            ...
            'photo': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['albums.Photo']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
