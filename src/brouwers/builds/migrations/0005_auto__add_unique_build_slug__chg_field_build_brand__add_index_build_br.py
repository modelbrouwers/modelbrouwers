...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Build.brand'
        db.delete_column('builds_build', 'brand')

        # Adding unique constraint on 'Build', fields ['slug']
        db.create_unique('builds_build', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Build', fields ['slug']
        db.delete_unique('builds_build', ['slug'])

        # Adding field 'Build.brand'
        db.add_column('builds_build', 'brand',
