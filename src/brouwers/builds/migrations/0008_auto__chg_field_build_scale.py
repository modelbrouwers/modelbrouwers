...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Build.scale_int'
        db.add_column('builds_build', 'scale_int',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Build.scale_int'
        db.delete_column('builds_build', 'scale_int')
    ...
    models = {
        ...
        'builds.build': {
            ...
            'scale_int': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
