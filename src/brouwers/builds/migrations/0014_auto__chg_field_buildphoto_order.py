...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BuildPhoto.order'
        db.alter_column('builds_buildphoto', 'order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'BuildPhoto.order'
        db.alter_column('builds_buildphoto', 'order', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
