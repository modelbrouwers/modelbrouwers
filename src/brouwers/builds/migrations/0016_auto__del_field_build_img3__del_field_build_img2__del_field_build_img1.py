...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Build.img3'
        db.delete_column('builds_build', 'img3')

        # Deleting field 'Build.img2'
        db.delete_column('builds_build', 'img2')

        # Deleting field 'Build.img1'
        db.delete_column('builds_build', 'img1')


    def backwards(self, orm):
        # Adding field 'Build.img3'
        db.add_column('builds_build', 'img3',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Build.img2'
        db.add_column('builds_build', 'img2',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Build.img1'
        db.add_column('builds_build', 'img1',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)
