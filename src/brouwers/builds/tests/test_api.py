            ...
            [
                {
                    "display": "BBT",
                    "url": reverse(
                        "builds:user_build_list", kwargs={"user_id": self.user1.id}
                    ),
                },
                {
                    "display": "BBT - Honda McJugen",
                    "url": reverse(
                        "builds:detail", kwargs={"slug": self.builds_user1[1].slug}
                    ),
                },
                {
                    "display": "BBT - Sopwith Triplane",
                    "url": reverse(
                        "builds:detail", kwargs={"slug": self.builds_user1[0].slug}
                    ),
                },
            ],
        )
