    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "forum",
                    brouwers.forum_tools.fields.ForumToolsIDField(
                        type="forum", null=True, verbose_name="forum", blank=True
                    ),
                ),
                (
                    "icon_class",
                    models.CharField(
                        max_length=50, verbose_name="icon class", blank=True
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "link_id",
                    models.CharField(
                        help_text="HTML id of the base anchor.",
                        max_length=128,
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Enable the syncing of this link.",
                ...
                (
                    "from_date",
                    models.DateField(
                        help_text="Start date from when this link is enabled.",
                ...
                (
                    "to_date",
                    models.DateField(
                        help_text="End date from when this link is enabled, this date included.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "link_id",
                    models.CharField(
                        help_text="HTML id of the anchor to be synced.",
                        max_length=128,
                        verbose_name="link id",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="forum_tools.ForumLinkBase",
                        help_text="Link this link syncs with.",
                        on_delete=models.CASCADE,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "forum",
                    brouwers.forum_tools.fields.ForumToolsIDField(
                        type="forum", null=True, verbose_name="forum id", blank=True
                    ),
                ),
                (
                    "min_posts",
                    models.PositiveSmallIntegerField(
                        verbose_name="minimum number of posts"
                    ),
                ),
                (
                    "posting_level",
                    models.CharField(
                        max_length=1,
                        verbose_name="posting level",
                        choices=[("T", "Topic"), ("R", "Reply")],
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "user_id",
                    models.AutoField(
                        help_text="Primary key", serialize=False, primary_key=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Closed reports need no more attention.",
                        verbose_name="closed",
                    ),
                ),
                (
                    "report_time_int",
                    models.IntegerField(
                        help_text="UNIX time when the report was added.",
                        verbose_name="time",
            ...
            options={
                ...
                "permissions": (
                    ("can_see_reports", "Can see (number of) open reports"),
                ),
                "managed": settings.TESTING,
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_post_time",
                    models.BigIntegerField(default=0, db_column="topic_last_post_time"),
                ),
                (
                    "create_time",
                    models.BigIntegerField(default=0, db_column="topic_time"),
                ),
                (
                    "forum",
                    models.ForeignKey(to="forum_tools.Forum", on_delete=models.CASCADE),
                ),
                (
                    "author",
                    models.ForeignKey(
                        to="forum_tools.ForumUser",
