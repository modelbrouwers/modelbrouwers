...
class ShowCasedModel(models.Model):
    ...
    remarks = models.TextField(
        _('remarkable elements'), blank=True,
...
class Competition(models.Model):
    ...
    max_num_models = models.PositiveSmallIntegerField(
        _('models per participant'), default=0,
    ...
    is_current = models.BooleanField(
        _('current open competition?'), default=False,
        help_text=_('Marking this competition as active will deactivate all other competitions.'))
