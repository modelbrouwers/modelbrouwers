...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='category',
            name='seo_keyword',
            field=models.CharField(blank=True, max_length=100, null=True, verbose_name='seo keyword'),
        ),
        migrations.AddField(
            model_name='category',
            name='seo_keyword_de',
        ...
        migrations.AlterField(
            model_name='category',
            name='image',
            field=models.ImageField(blank=True, upload_to='shop/category/', verbose_name='thumbnail'),
        ),
        migrations.AlterField(
            model_name='category',
            name='name',
