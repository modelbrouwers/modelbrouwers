...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupBuild.slug'
        db.alter_column(u'groupbuilds_groupbuild', 'slug', self.gf('autoslug.fields.AutoSlugField')(default='my-unused-slug', unique=True, max_length=50, populate_from='theme', unique_with=()))

    def backwards(self, orm):

        # Changing field 'GroupBuild.slug'
        db.alter_column(u'groupbuilds_groupbuild', 'slug', self.gf('autoslug.fields.AutoSlugField')(populate_from='theme', unique=True, max_length=50, null=True, unique_with=()))
