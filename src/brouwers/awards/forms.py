...
class ProjectForm(forms.ModelForm):
    ...
    class Meta:
        model = Project
        exclude = ("votes", "nomination_date", "rejected", "submitter", "last_reviewer")
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["url"].widget.attrs[
            "placeholder"
        ] = "http://www.modelbrouwers.nl/phpBB3/viewtopic.php?f=42&t=10"
        ...
        try:
            ...
            if profile.exclude_from_nomination:
                raise forms.ValidationError(
                    _("This person does not wish to participate in the awards.")
                )
        return brouwer
...
class VoteForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["project1"].error_messages["required"] = _(
            "When voting," " you cannot leave the first place blank."
        )
    ...
    def clean(self):
        ...
        if project1 and project3 and not project2:
            raise forms.ValidationError(
                _(
                    "The order of votes must be logical. "
