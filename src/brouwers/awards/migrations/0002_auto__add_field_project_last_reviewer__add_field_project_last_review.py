...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.last_reviewer'
        db.add_column('awards_project', 'last_reviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.last_review'
        db.add_column('awards_project', 'last_review',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.last_reviewer'
        db.delete_column('awards_project', 'last_reviewer_id')

        # Deleting field 'Project.last_review'
        db.delete_column('awards_project', 'last_review')
