...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Project', fields ['nomination_date']
        db.create_index('awards_project', ['nomination_date'])


    def backwards(self, orm):
        # Removing index on 'Project', fields ['nomination_date']
        db.delete_index('awards_project', ['nomination_date'])
