...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegistrationAttempt.ban'
        db.alter_column('general_registrationattempt', 'ban_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['banning.Ban'], unique=True, null=True))
        # Adding unique constraint on 'RegistrationAttempt', fields ['ban']
        db.create_unique('general_registrationattempt', ['ban_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RegistrationAttempt', fields ['ban']
        db.delete_unique('general_registrationattempt', ['ban_id'])


        # Changing field 'RegistrationAttempt.ban'
        db.alter_column('general_registrationattempt', 'ban_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['banning.Ban'], null=True))
