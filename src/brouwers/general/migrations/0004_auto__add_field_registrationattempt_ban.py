...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistrationAttempt.ban'
        db.add_column('general_registrationattempt', 'ban',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['banning.Ban'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegistrationAttempt.ban'
        db.delete_column('general_registrationattempt', 'ban_id')
    ...
    models = {
        ...
        'general.registrationattempt': {
            ...
            'answer': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'ban': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['banning.Ban']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
