...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.allow_sharing'
        db.add_column('general_userprofile', 'allow_sharing',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.allow_sharing'
        db.delete_column('general_userprofile', 'allow_sharing')
