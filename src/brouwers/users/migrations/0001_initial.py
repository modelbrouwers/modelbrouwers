        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "username_clean",
                    models.CharField(
                        max_length=30, verbose_name="cleaned username", blank=True
                    ),
                ),
                (
                    "first_name",
                ...
                (
                    "email",
                    models.EmailField(max_length=75, verbose_name="email address"),
                ),
                (
                    "is_staff",
                    models.BooleanField(
                ...
                (
                    "forumuser_id",
                    models.IntegerField(
                        null=True, verbose_name="forum user id", blank=True
                    ),
                ),
                (
                    "groups",
