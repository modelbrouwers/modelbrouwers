            ...
            <ul className="cart__products">
              {cart.products.map((cp, i) => (
                <li key={cp.id} className="cart-product cart-product--small">
                  ...
                  <div className="cart-product__price">&euro; {cp.totalStr}</div>
                  <div className="cart-product__remove" onClick={() => cart.removeProduct(cp.id)}>
...
export default observer(TopbarCart);
