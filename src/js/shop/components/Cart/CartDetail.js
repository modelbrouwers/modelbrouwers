          ...
          {store.products.map((cp, i) => (
            <tr key={cp.id}>
              ...
              <td className="cart-detail__quantity">
                <AmountControls store={store} cartProduct={cp} id={cp.product.id} />
              </td>
              <td>
                <p className="cart-detail__unit-price">&euro; {cp.product.price}</p>
              </td>
              <td>
                <p className="cart-detail__product-total">&euro; {cp.totalStr}</p>
              </td>
            </tr>
          ))}
        </tbody>
        ...
        <div className="cart-detail__totals">
          <div className="cart-detail__inner">
            ...
            <div className="cart-detail__info-row">
              ...
              <span className="cart-detail__value">&euro; {store.total}</span>
            </div>
          </div>
