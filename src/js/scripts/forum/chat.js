    ...
    $(function() {
        ...
        $("a")
            ...
            .click(function() {
                if (chat_opened) {
                    html =
                        "<p>De chat staat nog open. Indien je de pagina niet in een niew tabblad/venster opent, zal je chatsessie niet meer actief zijn.</p>";
                    html +=
                        "<br /><p>Je kan de pagina in een nieuw venster of tabblad openen, of de chat sluiten en de pagina in dit venster openen.</p>";
