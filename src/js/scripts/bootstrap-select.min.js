...
!(function(b) {
    ...
    a.prototype = {
        ...
        render: function(e) {
            ...
            var g = !this.multiple
                ? h[0]
                : h.join(this.options.multipleSeparator);
            if (
                this.multiple &&
        ...
        liHeight: function() {
            ...
            var f = this.$menu
                ...
                d = this.options.header
                    ? g.find(".popover-title").outerHeight()
                    : 0,
        ...
        selectPosition: function() {
            var e = this,
                ...
                c = function(i) {
                    f.addClass(
                        i.attr("class").replace(/form-control/gi, "")
            ...
            this.$searchbox.on("input propertychange", function() {
                if (d.$searchbox.val()) {
                    d.$lis
                        ...
                        .addClass("hide");
                    if (
                        !d.$menu.find("li").filter(":visible:not(.no-results)")
                            .length
                    ) {
                        if (!!c.parent().length) {
                            c.remove();
