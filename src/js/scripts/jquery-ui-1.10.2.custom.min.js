...
(function(e, t) {
    ...
    (e.cleanData = function(t) {
        ...
        (e.widget.extend = function(i) {
            for (
                var n, a, r = s.call(arguments, 1), o = 0, h = r.length;
                h > o;
                o++
            )
                for (n in r[o])
        ...
        (e.widget.bridge = function(i, n) {
            ...
            e.fn[i] = function(r) {
                ...
                return (
                    (r =
                        !o && h.length
                            ? e.widget.extend.apply(null, [r].concat(h))
                            : r),
                    o
                        ? this.each(function() {
                              var s,
            ...
            option: function(i, s) {
                ...
                if ("string" == typeof i)
                    if (
                        ...
                        for (
                            a = o[i] = e.widget.extend({}, this.options[i]),
                                r = 0;
                            n.length - 1 > r;
                            r++
                        )
                ...
                if (!t) {
                    ...
                    var s = this,
                        ...
                        a =
                            ...
                            i.target.nodeName
                                ? e(i.target).closest(this.options.cancel)
                                      .length
                                : !1;
        ...
        _mouseCapture: function(t) {
            ...
            return this.helper ||
                ...
                : ((this.handle = this._getHandle(t)),
                  this.handle
                      ? (e(i.iframeFix === !0 ? "iframe" : i.iframeFix).each(
                            function() {
                                e(
        ...
        _setContainment: function() {
            ...
            if (
                ...
                (t = "hidden" !== e(s).css("overflow")),
                    (this.containment = [
                        (parseInt(e(s).css("borderLeftWidth"), 10) || 0) +
                            (parseInt(e(s).css("paddingLeft"), 10) || 0),
                        (parseInt(e(s).css("borderTopWidth"), 10) || 0) +
                            (parseInt(e(s).css("paddingTop"), 10) || 0),
                        (t
                            ? Math.max(s.scrollWidth, s.offsetWidth)
                            : s.offsetWidth) -
                            (parseInt(e(s).css("borderRightWidth"), 10) || 0) -
                            (parseInt(e(s).css("paddingRight"), 10) || 0) -
                            this.helperProportions.width -
                            this.margins.left -
                            this.margins.right,
                        (t
                            ...
                            : s.offsetHeight) -
                            (parseInt(e(s).css("borderBottomWidth"), 10) || 0) -
                            (parseInt(e(s).css("paddingBottom"), 10) || 0) -
                            this.helperProportions.height -
                            this.margins.top -
                            this.margins.bottom
                    ]),
            ...
            return (
                this.originalPosition &&
                    ...
                    o.grid &&
                        ((n = o.grid[1]
                            ? this.originalPageY +
                              Math.round((u - this.originalPageY) / o.grid[1]) *
                                  o.grid[1]
                            : this.originalPageY),
                        (u = i
                        ...
                        (a = o.grid[0]
                            ? this.originalPageX +
                              Math.round((l - this.originalPageX) / o.grid[0]) *
                                  o.grid[0]
                            : this.originalPageX),
                        (l = i
            ...
            drag: function(t, i) {
                ...
                for (c = p.snapElements.length - 1; c >= 0; c--)
                    (r = p.snapElements[c].left),
                        ...
                        (g > r - m && h + m > g && y > l - m && u + m > y) ||
                        (g > r - m && h + m > g && b > l - m && u + m > b) ||
                        (v > r - m && h + m > v && y > l - m && u + m > y) ||
                        (v > r - m && h + m > v && b > l - m && u + m > b)
                            ? ("inner" !== f.snapMode &&
                                  ((s = m >= Math.abs(l - b)),
                                  (n = m >= Math.abs(u - y)),
                                  (a = m >= Math.abs(r - v)),
            ...
            switch (s) {
                ...
                case "pointer":
                    return (
                        ...
                        t(a, d, i.proportions.height) &&
                            t(n, u, i.proportions.width)
                    );
                case "touch":
                    return (
                        ((h >= d && p >= h) ||
    ...
    e.widget("ui.resizable", e.ui.mouse, {
            ...
            if (
                ...
                for (
                    ...
                    (s = e.trim(t[i])),
                        ...
                        "se" === s &&
                            n.addClass("ui-icon ui-icon-gripsmall-diagonal-se"),
        ...
        _updateRatio: function(e) {
            ...
            return (
                ...
                "sw" === n &&
                    ((e.left = t.left + (s.width - e.width)), (e.top = null)),
                "nw" === n &&
        ...
        _proportionallyResize: function() {
            if (this._proportionallyResizeElements.length) {
                ...
                for (
                    ...
                    if (
                        ((n = this._proportionallyResizeElements[e]),
                        !this.borderDif)
                    )
                        for (
                            this.borderDif = [],
                    ...
                    n.css({
                        height:
                            a.height() -
                                ...
                                this.borderDif[2] || 0,
                        width:
                            a.width() - this.borderDif[1] - this.borderDif[3] ||
                            0
                    });
                }
            }
            ...
            resize: function(t) {
                ...
                d[0] !== document &&
                    ...
                    (s = Math.abs(
                        (o._helper
                            ? o.offset.top - c.top
                            : o.offset.top - h.top) + o.sizeDiff.height
                    )),
                    (n =
            ...
            return (
                ...
                this.originalPosition &&
                    ...
                    n.grid &&
                        ((i =
                            this.originalPageY +
                            Math.round((o - this.originalPageY) / n.grid[1]) *
                                n.grid[1]),
                        (o = this.containment
                        ...
                        (s =
                            this.originalPageX +
                            Math.round((a - this.originalPageX) / n.grid[0]) *
                                n.grid[0]),
                        (a = this.containment
...
(function(t) {
    ...
    (i.height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i.borderBottomWidth =
        "hide"),
        (s.height = s.paddingTop = s.paddingBottom = s.borderTopWidth = s.borderBottomWidth =
            "show"),
    ...
    t.extend(i.prototype, {
                ...
                "input" === i
                    ...
                    : ("div" === i || "span" === i) &&
                      ...
                      s
                          ...
                          .prop("disabled", !1)),
                (this._disabledInputs = t.map(this._disabledInputs, function(
                    t
                ) {
                    return t === e ? null : t;
                })));
                        ...
                        switch (l[2] || "d") {
                            ...
                            case "M":
                                (r += parseInt(l[1], 10)),
                                    (o = Math.min(
                                        o,
                                        t.datepicker._getDaysInMonth(a, r)
                                    ));
                                break;
                            case "y":
                            case "Y":
        ...
        _attachHandlers: function(e) {
            ...
            e.dpDiv.find("[data-handler]").map(function() {
                var e = {
                    prev: function() {
                        window["DP_jQuery_" + o].datepicker._adjustDate(
                            s,
                            -i,
                            "M"
                        );
                    ...
                    selectDay: function() {
                        return (
                            window["DP_jQuery_" + o].datepicker._selectDay(
                                s,
                    ...
                    selectMonth: function() {
                        return (
                            window[
                                "DP_jQuery_" + o
                            ].datepicker._selectMonthYear(s, this, "M"),
                            !1
                        );
                    },
                    selectYear: function() {
                        return (
                            window[
                                "DP_jQuery_" + o
                            ].datepicker._selectMonthYear(s, this, "Y"),
                            !1
                        );
                    }
                };
            ...
            for (
                ...
                for (x = "", this.maxRows = 4, D = 0; K[1] > D; D++) {
                    if (
                        ...
                        if (
                            ((S += "<div class='ui-datepicker-group"), K[1] > 1)
                        )
                            switch (D) {
                                case 0:
                    ...
                    for (
                        ...
                        for (
                            ...
                            (O = g
                                ? g.apply(t.input ? t.input[0] : null, [H])
                                : [!0, ""]),
                                (W = H.getMonth() !== Z),
                                (j =
                                    (W && !_) ||
...
(function(t) {
    t.widget("ui.menu", {
        ...
        _scrollIntoView: function(e) {
            ...
            this._hasScroll() &&
                ((i =
                    parseFloat(t.css(this.activeMenu[0], "borderTopWidth")) ||
                    0),
                        ...
                        (this._clickOffset = l
                            ...
                            : {
                                  ...
                                  top:
                                      ...
                                      h.top -
                                      a.height() / 2 -
                                      (parseInt(a.css("borderTopWidth"), 10) ||
                                          0) -
                                      (parseInt(
            ...
            this.options.values && this.options.values.length
                ? this.handles.each(function(s) {
                      (i =
                          ...
                          (u[
                              "horizontal" === h.orientation ? "left" : "bottom"
                          ] = i + "%"),
                          t(this)
                              .stop(1, 1)
                ...
                null === i &&
                    (n &&
                        this.tabs.each(function(s, a) {
                            return t(a).attr("aria-controls") === n
                                ? ((i = s), !1)
                                : e;
                        }),
                    null === i &&
            ...
            if (n) {
                ...
                s.is("[title]") &&
                    ...
                    this.options.track && i && /^mouse/.test(i.type)
                        ? (this._on(this.document, { mousemove: a }), a(i))
                        : o.position(
        ...
        (function(t, e) {
            ...
            function s(i) {
                ...
                return (
                    ...
                    n.length
                        ? ("0,0,0,0" === n.join() && t.extend(n, a.transparent),
                          s)
                        : a[i]
                );
            }
            ...
            (p.style.cssText = "background-color:rgba(1,1,1,.5)"),
                ...
                (t.cssHooks.borderColor = {
                    expand: function(t) {
                        var e = {};
                        return (
                            f(["Top", "Right", "Bottom", "Left"], function(
                                i,
                                s
                            ) {
                                e["border" + s + "Color"] = t;
...
(function(t) {
    ...
    t.effects.effect.blind = function(s, n) {
        ...
        h.parent().is(".ui-effects-wrapper")
            ...
            : t.effects.save(h, l),
            h.show(),
            (a = t.effects.createWrapper(h).css({ overflow: "hidden" })),
            (o = a[p]()),
...
(function(t) {
    t.effects.effect.pulsate = function(e, i) {
        var s,
            ...
            p = d.length;
        for (
            (o || !n.is(":visible")) && (n.css("opacity", 0).show(), (u = 1)),
                s = 1;
            l > s;
            s++
        )
        ...
        (t.effects.effect.size = function(e, i) {
            ...
            "show" === p && o.show(),
                ...
                ("box" === m || "both" === m) &&
                    (a.from.y !== a.to.y &&
                        ((_ = _.concat(u)),
                        (o.from = t.effects.setTransition(
                            o,
                            u,
                            a.from.y,
                            o.from
