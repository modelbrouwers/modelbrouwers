...
const RadioSelectOptionValue = PropTypes.oneOfType([PropTypes.string, PropTypes.number]);

const RadioSelectOption = ({name, htmlId, index, value, display, checked, onChange}) => {
